...
public record CustomerRequest(
        ...
        @Size(max = 255, message = "cannot exceed 255 characters") String residenceCity,
        @Pattern(regexp = "^[0-9]{5}$", message = "must be exactly 5 digits") String zipCode,
        @Pattern(regexp = "^([a-zA-Z0-9]{16}|[0-9]{11})$", message = "must be 16 alphanumeric characters or 11 digits") String fiscalCode,
        @Pattern(regexp = "^[0-9]{11}$", message = "must be exactly 11 digits") String vatNumber) {
}
